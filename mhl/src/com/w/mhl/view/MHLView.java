...
import com.w.mhl.service.BillService;
import com.w.mhl.service.DiningTableService;
import com.w.mhl.service.EmployeeService;
import com.w.mhl.service.MenuService;
import com.w.mhl.utils.Utility;
...
public class MHLView {
    ...
    public void listDiningTable() {
        List<DiningTable> diningTables = diningTableService.diningTableList();
        System.out.println("\n餐桌编号\t\t餐桌状态");
    ...
    public void orderMenu() {
        ...
        int orderNums = (int) Math.floor(Utility.readInt());
        if (orderNums == -1) {
            System.out.println("==========取消点餐==========");
            return;
        }
        if (orderNums <= 0) {
            System.out.println("==========点餐数量不符合==========");
            return;
        }
